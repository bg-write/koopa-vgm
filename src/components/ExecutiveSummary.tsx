  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 mb-8 border-l-4 border-koopa-green">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-4">
        <div>
          ...
          <p className="text-gray-700 mb-3">
            Koopa is a data-driven analysis of video game music (VGM) popularity using <strong>Spotify and YouTube streaming data</strong>. It&apos;s like a Billboard chart for video game music—identifying which tracks are actually being listened to today, not just historically important.
          </p>
        ...
        <div>
          ...
          <ul className="text-gray-700 space-y-2 mb-4">
            <li>• <strong>45 tracks</strong> analyzed across 40+ years of VGM history</li>
            <li>• <strong>Three data sources:</strong> Spotify, YouTube, and RAWG APIs</li>
            <li>• <strong>Key deliverables:</strong> Interactive chart, Tableau dashboard, and a comprehensive case study</li>
          </ul>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-2 md:gap-6">
          <div>
            <ul className="text-gray-700 space-y-2">
              ...
              <li>• <strong>Only 9%</strong> of tracks have Spotify releases credited before 2010, but <strong>56%</strong> of games were released before 2010, showing classic VGM&apos;s lasting appeal through streaming platforms</li>
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-koopa-green/5 to-blue-50 rounded-lg border border-koopa-green/20">
        <h3 className="text-lg font-semibold text-koopa-green mb-3">💼 OK, So What?</h3>
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <ul className="text-gray-700 space-y-1 text-sm">
              ...
              <li>• <strong>r=0.663 correlation</strong> validates cross-platform strategy and retro VGM licensing</li>
            </ul>
          </div>
        </div>
      </div>
